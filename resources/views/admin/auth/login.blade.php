    ...
    <div class="auth-inner py-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <h4>Hello! Admin 👋</h4>
          <h4 class="card-title mb-1">Welcome to Bestmedsys! 👋</h4>
          ...
          <form class="auth-login-form mt-2" action="{{ route('admin.login') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" name="email"
                placeholder="issam@example.com" aria-describedby="login-email" tabindex="1"  required autocomplete="email" autofocus />               
                @error('email')
            ...
            <div class="form-group">
              <div class="custom-control custom-checkbox">
                <input class="custom-control-input form-check-input" type="checkbox" id="remember" name="remember" tabindex="3" {{ old('remember') ? 'checked' : '' }}/>
